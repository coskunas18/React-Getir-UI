        ...
        <div className="bg-brand-color ">
            <div className="container mx-auto h-16 md:h-11 flex items-center justify-center md:justify-between ">
                <a href="#">
                 ...
                 <nav className="hidden md:flex items-center gap-x-4 text-sm font-semibold">
                    <a href="#" className="flex items-center gap-x-2 text-white text-opacity-80 transition-all hover:text-opacity-100">
                        <BsGlobe size={15}/>
                        Türkçe (TR)
                    </a>
                    <a href="#" className="flex items-center gap-x-2 text-white text-opacity-80 transition-all hover:text-opacity-100">
